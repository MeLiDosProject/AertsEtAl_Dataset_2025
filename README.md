...
<!-- [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.16568109.svg)](https://doi.org/10.5281/zenodo.16568109) -->
...
[MeLiDos](www.melidos.eu) field study site of Delft, The Netherlands.
Data were collected by [The Hague University of Applied Sciences
(THUAS)](https://www.thuas.com) and are further processed and analysed
...
> Spitschan, M. (2025). Personal light exposure dataset for Delft, The
> Netherlands (Version 1.0.0) \[Data set\]. URL:
> <https://github.com/MeLiDosProject/AertsEtAl_Dataset_2025>. DOI: xyz
...
- `data/Metadata_MeLiDos_THUAS.xlsx`: Preliminary Metadata prior to
  conversion to JSON

- `data/Study_dates_MeLiDos_THUAS.xlsx`: Recruitment dates to clean
